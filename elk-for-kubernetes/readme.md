...
```
helm 项目地址：  https://hub.helm.sh/charts/stable/nfs-client-provisioner
...
# 使用镜像
image:
  repository: feixiangkeji974907/nfs-client-provisioner
# 副本数量
replicaCount: 3
EOF

#helm 部署 nfs-client-provisioner
helm install elk-nfs-client -n nfs --values elk-nfs.yaml stable/nfs-client-provisioner --version 1.2.8
```
